...
\begin{table}
  ...
  \begin{tabulary}{\textwidth}{C|L|C|C}
    ...
    \hline
    \lit*{string} or \lit*{char[]} & Output a string & ``\"Hello\"'' & \"Hello\" \\
    \hline
    Other Array Types & Output the starting address of the array in hexadecimal & *{{1, 2, 3}}\footnotemark[1] & \"0x134\" \\
    \hline
...
\begin{table}
  ...
  \begin{tabular}{cclc}
    ...
    \b & \lit*{0x08} & backspace & BS \\
    \t & \lit*{0x09} & Horizontal Tab & TAB \\
    \n & \lit*{0x0a} & Newline (line feed) & LF \\
    \f & \lit*{0x0c} & Formfeed & FF \\
...
\item The \lit{ord} operator returns the integer value of the evaluation of its sub-expression. \fillgap{Define/describe the \lit{ord} operator}{1 mark}

\item The \lit{chr} operator returns the ASCII character that corresponds to the evaluation of its sub-expression. \fillgap{Define/describe the \lit{chr} operator}{1 mark}
...
\begin{table}
  ...
  \begin{tabulary}{\textwidth}{CCCCCL}
    ...
    \lit{>} & 3 & \lit*{char} & \lit*{char} & \lit*{bool} & Greater Than \\
    \lit{>} & 3 & \lit*{int} & \lit*{int} & \lit*{bool} & Greater Than \\
    \lit{>=} & 3 & \lit*{char} & \lit*{char} & \lit*{bool} & Greater Than or Equal \\
    \lit{>=} & 3 & \lit*{int} & \lit*{int} & \lit*{bool} & Greater Than or Equal \\
    \lit{<} & 3 & \lit*{char} & \lit*{char} & \lit*{bool} & Less Than \\
    \lit{<} & 3 & \lit*{int} & \lit*{int} & \lit*{bool} & Less Than \\
    \lit{<=} & 3 & \lit*{char} & \lit*{char} & \lit*{bool} & Less Than or Equal \\
    \lit{<=} & 3 & \lit*{int} & \lit*{int} & \lit*{bool} & Less Than or Equal \\
    \lit{==} & 4 & \lit*{char} & \lit*{char} & \lit{bool} & Equality \\
    \lit{==} & 4 & \lit*{int} & \lit*{int} & \lit{bool} & Equality \\
    \lit{!=} & 4 & \lit*{char} & \lit*{char} & \lit{bool} & Inequality \\
    \lit{!=} & 4 & \lit*{int} & \lit*{int} & \lit{bool} & Inequality \\
